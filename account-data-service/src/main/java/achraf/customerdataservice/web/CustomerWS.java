 ...
 * 2024-05-14T23:12:50.296+01:00
 * Generated source version: 4.0.0
 *
 */
@WebServiceClient(name = "CustomerWS",
                  wsdlLocation = "file:/home/achraf/IdeaProjects/TP-MICROSERVICE-CONNECTORS/account-data-service/src/main/resources/customerService.wsdl",
                  targetNamespace = "http://web.customerdataservice.achraf/")
public class CustomerWS extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://web.customerdataservice.achraf/", "CustomerWS");
    public final static QName CustomerSoapServicePort = new QName("http://web.customerdataservice.achraf/", "CustomerSoapServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/home/achraf/IdeaProjects/TP-MICROSERVICE-CONNECTORS/account-data-service/src/main/resources/customerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/achraf/IdeaProjects/TP-MICROSERVICE-CONNECTORS/account-data-service/src/main/resources/customerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
